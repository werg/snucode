...
var CodeMirror = (function() {
  ...
  function CodeMirror(place, givenOptions) {
    ...
    function endOperation(silent) {
      ...
      if (tc && options.onChange && instance && !silent)
    ...
    function operation(f) {
      return function() {
        ...
        try {var result = f.apply(this, arguments);}
          ...
          if (!--nestedOperation){        
            var silent = false;
            if(arguments.length > 0 && arguments[arguments.length-1].silent != undefined){
              silent = arguments[arguments.length-1].silent;
            }
           endOperation(silent);}
          }
        return result;
